SectionFront = React.createClass({displayName: "SectionFront",
	...
	render : function() {
		return (
			React.createElement("ul", {id: "xLister", class: "list Xul"}, 
...
SectionItem = React.createClass({displayName: "SectionItem",
	render : function(){
		...
		return (
			React.createElement("li", {class: "Xli", style: "overflow:hidden;", key: this.props.index}, 
				React.createElement("div", {class: "list_story_image", style: {backgroundImage : this.props.story.image, backgroundSize: "cover"}}), 
